...
name = 'predict_trunk_extension'
scenarios = ['ext_0', 'ext_5', 'ext_10', 'ext_15', 'ext_20']
...
fig1.suptitle('Drop - Landing: Lumbar Extension case study',
...
fig3.suptitle('Drop - Landing: Lumbar Extension case study',
                 fontsize=26, fontweight='bold')
...
fig_sol.suptitle('Drop - Landing: Lumbar Extension case study',
                 fontsize=26, fontweight='bold')
