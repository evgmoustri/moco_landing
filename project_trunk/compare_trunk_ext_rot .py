...
# Internal
name = 'predict_trunk_rot_ext'
scenarios = ['rot_0', 'rot_-5', 'rot_-10', 'rot_-15', 'rot_-20', 'rot_-25',
             'rot_-30']
...
fig1.suptitle('Drop - Landing: Lumbar External Rotation case study',
...
fig3.suptitle('Drop - Landing: Lumbar External Rotation case study',
                 fontsize=26, fontweight='bold')
...
fig_sol.suptitle('Drop - Landing: Lumbar External Rotation case study',
                 fontsize=26, fontweight='bold')
