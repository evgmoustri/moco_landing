...
name = 'predict_trunk_flexion'
scenarios = ['ext_0', 'ext_-5', 'ext_-9', 'ext_-15', 'ext_-20', 'ext_-25',
             'ext_-30']
...
fig1.suptitle('Drop - Landing: Lumbar Flexion case study',
...
fig3.suptitle('Drop - Landing: Lumbar Flexion case study',
                 fontsize=26, fontweight='bold')
...
fig_sol.suptitle('Drop - Landing: Lumbar Flexion case study',
                 fontsize=26, fontweight='bold')
