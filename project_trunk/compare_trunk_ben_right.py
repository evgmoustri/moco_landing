...
# Internal
name = 'predict_trunk_ben_right'
scenarios = ['ext_0', 'ben_5', 'ben_10', 'ben_15', 'ben_20', 'ben_25',
             'ben_30']
...
fig1.suptitle('Drop - Landing: Lumbar Right Bending case study',
...
fig3.suptitle('Drop - Landing: Lumbar Right Bending case study',
              fontsize=26, fontweight='bold')
...
fig_sol.suptitle('Drop - Landing: Lumbar Right Bending case study',
              fontsize=26, fontweight='bold')
