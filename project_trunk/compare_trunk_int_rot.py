...
# Internal
name = 'predict_trunk_rot_int'
scenarios = ['rot_0', 'rot_4', 'rot_10', 'rot_15', 'rot_20', 'rot_25',
             'rot_30']
...
fig1.suptitle('Drop - Landing: Lumbar Internal Rotation case study',
...
fig3.suptitle('Drop - Landing: Lumbar Internal Rotation case study',
              fontsize=26, fontweight='bold')
...
fig_sol.suptitle('Drop - Landing: Lumbar Internal Rotation case study',
              fontsize=26, fontweight='bold')
