...
# at_dict = {
    ...
    #     'lumbar_ben_final': 0},
    # 1: {'scenario': 'ext_-5', 'lumbar_ext_final': -5, 'lumbar_rot_final': 0,
    #     'lumbar_ben_final': 0},
    # 2: {'scenario': 'ext_0', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
    #     'lumbar_ben_final': 0},
    # 3: {'scenario': 'ext_5', 'lumbar_ext_final': 5, 'lumbar_rot_final': 0,
    #     'lumbar_ben_final': 0},
    # 4: {'scenario': 'ext_10', 'lumbar_ext_final': 10, 'lumbar_rot_final': 0,
    #     'lumbar_ben_final': 0},
    # 5: {'scenario': 'ext_15', 'lumbar_ext_final': 15, 'lumbar_rot_final': 0,
    #     'lumbar_ben_final': 0},
    # 6: {'scenario': 'ext_20', 'lumbar_ext_final': 20, 'lumbar_rot_final': 0,
    #     'lumbar_ben_final': 0},
    # 7: {'scenario': 'ext_25', 'lumbar_ext_final': 25, 'lumbar_rot_final': 0,
    #     'lumbar_ben_final': 0}}
#Rotation
# at_dict = {
