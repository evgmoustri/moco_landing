...
# Internal
name = 'predict_hip_effort0.001_external'
scenarios = ['rot_0', 'rot_-5', 'rot_-10', 'rot_-15', 'rot_-20', 'rot_-24',
             'rot_-29']
...
ax5.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax5.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax5.set_ylabel('external rotation moment(-)', fontsize=16)
ax5.set_xlabel('Time (sec)', fontsize=13)
ax5.grid(True)
lg5 = ax5.legend(handles, labels, prop={'weight': 'bold', 'size': 10},
...
fig_sol.suptitle('Hip external rotation',
...
for idx, fit in enumerate(scenarios):
    ...
    handles.append(line)
    labels.append(labels_sen[idx])
ax5.set_ylabel('Hip external rotation(+)', fontsize=16)
ax5.set_xlabel('Time (sec)', fontsize=13)
ax5.grid(True)
ax5.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax5.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
