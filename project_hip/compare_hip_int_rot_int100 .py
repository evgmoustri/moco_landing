...
results_path = os.path.abspath(project_path +
                               "/Results/Compare/predict_hip_effort0.001_2/")
if not os.path.isdir(results_path):
    os.makedirs(results_path)
results_path_trunk = os.path.abspath(project_path +
                                     "/Results/predict_hip_effort0.001_2")

# Internal
name = 'predict_hip_effort0.001_internal'
scenarios = ['rot_0', 'rot_5', 'rot_10', 'rot_15', 'rot_19', 'rot_25',
             'rot_30']

labels_sen = [r'$0\degree$', r'$5\degree$', r'$10\degree$', r'$15\degree$',
              r'$20\degree$', r'$25\degree$', r'$30\degree$']

my_colors = ['royalblue', 'cadetblue', 'mediumpurple','darkkhaki', 'peru',
               'darkred', 'darkslategrey']
...
fig1.suptitle('Hip internal rotation', fontsize=26, fontweight='bold')
spec1 = gridspec.GridSpec(ncols=ncol, nrows=nr, figure=fig1)
ax1 = fig1.add_subplot(spec1[0, 0])
for idx, fit in enumerate(scenarios):
    line, = ax1.plot(time_arrays[:,idx],savgol_filter(fx[:, idx], window,
                      order,mode='nearest'), color=my_colors[idx])
    handles.append(line)
    labels.append(labels_sen[idx])
time_maxfy = time_arrays[max_fy_id[0],0]
time_igc = time_arrays[idx_igc[0], 0]
ax1.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax1.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax1.set_ylabel('Fx', fontsize=16)
...
for idx, fit in enumerate(scenarios):
    line, = ax2.plot(time_arrays[:,idx], savgol_filter(fy[:, idx], window,
                      order,mode='nearest'), color=my_colors[idx])
    handles.append(line)
    labels.append(labels_sen[idx])
time_maxfy = time_arrays[max_fy_id[0],0]
time_igc = time_arrays[idx_igc[0],0]
ax2.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax2.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax2.set_ylabel('Fy', fontsize=16)
...
time_maxfy = time_arrays[max_fy_id[0],0]
time_igc = time_arrays[idx_igc[0], 0]
ax3.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax3.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax3.set_ylabel('Fz', fontsize=16)
ax3.set_xlabel('Time (sec)', fontsize=13)
ax3.grid(True)
lg3 = ax3.legend(handles, labels, prop={'weight': 'bold', 'size': 10},
                 loc='lower left', handletextpad=0.4, handlelength=0.5)
...
for idx, fit in enumerate(scenarios):
    line, = ax4.plot(time_arrays[:,0], savgol_filter(mx[:, idx],window,order,
                      mode='nearest'),  color=my_colors[idx])
    handles.append(line)
    labels.append(labels_sen[idx])
time_maxfy = time_arrays[max_fy_id[0],0]
time_igc = time_arrays[idx_igc[0], 0]
ax4.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax4.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax4.set_ylabel('Mx', fontsize=16)
...
for idx, fit in enumerate(scenarios):
    line, = ax5.plot(time_arrays[:,idx], savgol_filter(my[:, idx], window,
                        order, mode='nearest'), color=my_colors[idx])
    handles.append(line)
    labels.append(labels_sen[idx])
time_maxfy = time_arrays[max_fy_id[0],0]
time_igc = time_arrays[idx_igc[0], 0]
ax5.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax5.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax5.set_ylabel('My', fontsize=16)
ax5.set_xlabel('Time (sec)', fontsize=13)
ax5.grid(True)
...
time_maxfy = time_arrays[max_fy_id[0],0]
time_igc = time_arrays[idx_igc[0], 0]
ax6.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax6.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax6.set_ylabel('Mz', fontsize=16)
ax6.set_xlabel('Time (sec)', fontsize=13)
ax6.grid(True)
...
plt.savefig(results_path + '/' + name + '_GRF.png')
if plots == 1:
    plt.show()
...
spec1 = gridspec.GridSpec(ncols=ncol, nrows=nr, figure=fig1)
# fig1.suptitle('Hip external rotation', fontsize=26, fontweight='bold')
fig1.suptitle('Hip internal rotation', fontsize=26, fontweight='bold')
ax1 = fig1.add_subplot(spec1[0, 0])
for idx, fit in enumerate(scenarios):
...
ax1.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax1.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax1.set_ylabel('Anterior force(+)', fontsize=16)
ax1.set_xlabel('Time (sec)', fontsize=13)
ax1.grid(True)
lg1 = ax1.legend(handles, labels, prop={'weight': 'bold', 'size': 10},
                 loc='upper left', handletextpad=0.4, handlelength=0.5)
...
ax2.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax2.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax2.set_ylabel('Compressive force(-)', fontsize=16)
ax2.set_xlabel('Time (sec)', fontsize=13)
ax2.grid(True)
...
ax3.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax3.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax3.set_ylabel('Medial force(+)', fontsize=16)
ax3.set_xlabel('Time (sec)', fontsize=13)
ax3.grid(True)
lg3 = ax3.legend(handles, labels, prop={'weight': 'bold', 'size': 10},
                 loc='upper left', handletextpad=0.4, handlelength=0.5)
...
ax4.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax4.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax4.set_ylabel('Abduction moment(+)', fontsize=16)
ax4.set_xlabel('Time (sec)', fontsize=13)
ax4.grid(True)
lg4 = ax4.legend(handles, labels, prop={'weight': 'bold', 'size': 10},
                 loc='lower right', handletextpad=0.4, handlelength=0.5)
for line in lg4.get_lines():
    line.set_linewidth(8)
...
ax5.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax5.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax5.set_ylabel('Internal rotation moment(-)', fontsize=16)
ax5.set_xlabel('Time (sec)', fontsize=13)
ax5.grid(True)
lg5 = ax5.legend(handles, labels, prop={'weight': 'bold', 'size': 10},
...
ax6.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax6.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
ax6.set_ylabel('Flexion moment(+)', fontsize=16)
ax6.set_xlabel('Time (sec)', fontsize=13)
ax6.grid(True)
lg6 = ax6.legend(handles, labels, prop={'weight': 'bold', 'size': 10},
                 loc='upper left', handletextpad=0.4, handlelength=0.5)
...
# fig3.suptitle('Hip external rotation', fontsize=26, fontweight='bold')
fig3.suptitle('Hip internal rotation', fontsize=26, fontweight='bold')
...
# idx_igc = [x-12 for x in idx_igc]
# max_fy_id = [x-12 for x in max_fy_id]
...
for idx, sen in enumerate(scenarios):
    ...
    # ham_force = ham_force[:, ]
    # quad_force = quad_force[:, ]
    # gastro_force = gastro_force[:, ]
    # ta_force = ta_force[:, ]
    # sol_force = sol_force[:, ]
    ...
    line_2, = ax2.plot(time_arrays_2[:], savgol_filter(
        ham_force,9,3,mode='nearest'),color=my_colors[idx])
    line_3, = ax3.plot(time_arrays_2[:], savgol_filter(qh_ratio,
            9,3,mode='nearest'), color=my_colors[idx])
    line_4, = ax4.plot(time_arrays_2[:], savgol_filter(
        gastro_force,9,3,mode='nearest'),  color=my_colors[idx])
    line_5, = ax5.plot(time_arrays_2[:], savgol_filter(
        ta_force,9,3,mode='nearest'),  color=my_colors[idx])
    line_6, = ax6.plot(time_arrays_2[:], savgol_filter(
        gta_ratio,9,3,mode='nearest'),  color=my_colors[idx])
...
ax1.set_ylabel('Quadriceps force', fontsize=16)
ax1.set_xlabel('Time (sec)', fontsize=13)
ax1.grid(True)
time_maxfy = time_arrays_2[max_fy_id[0]]
time_igc = time_arrays_2[idx_igc[0]]
ax1.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax1.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
lg1 = ax1.legend(handles, labels, prop={'weight': 'bold', 'size': 10},
                  loc='upper left', handletextpad=0.4, handlelength=0.5)

ax2.set_ylabel('Hamstrings force', fontsize=16)
ax2.set_xlabel('Time (sec)', fontsize=13)
ax2.set_title('Muscle forces and Muscle Force Ratios', fontsize=20,
              fontweight='bold')
ax2.grid(True)
ax2.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax2.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
...
ax3.set_ylabel('Q/H Ratio', fontsize=16)
ax3.set_xlabel('Time (sec)', fontsize=13)
ax3.grid(True)
ax3.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax3.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
...
ax4.set_ylabel('Gastrocnemius force', fontsize=16)
ax4.set_xlabel('Time (sec)', fontsize=13)
ax4.grid(True)
ax4.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax4.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
...
ax5.set_ylabel('Tibialis anterior force', fontsize=16)
ax5.set_xlabel('Time (sec)', fontsize=13)
ax5.grid(True)
ax5.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax5.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
...
ax6.set_ylabel('GTA Ratio', fontsize=16)
ax6.set_xlabel('Time (sec)', fontsize=13)
ax6.grid(True)
ax6.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax6.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
...
handles = []
labels = []
fig_sol = plt.figure(constrained_layout=True, figsize=(18, 8))
mid = (fig_sol.subplotpars.right + fig_sol.subplotpars.left + 0.015)/2
fig_sol.suptitle('Hip internal rotation',
                 fontsize=26, fontweight='bold',x=mid)
spec_sol = gridspec.GridSpec(ncols=ncol, nrows=nr, figure=fig_sol)
ax1 = fig_sol.add_subplot(spec1[0, 0])
for idx, fit in enumerate(scenarios):
    line, = ax1.plot(sol_time_arrays[:,0], savgol_filter(hip_flexions[:, idx],
                                                   window,order,
                                    mode='nearest'), color=my_colors[idx])
    handles.append(line)
    labels.append(labels_sen[idx])

ax1.set_ylabel('Hip flexion(+)', fontsize=16)
ax1.set_xlabel('Time (sec)', fontsize=13)
ax1.grid(True)
...
for idx, fit in enumerate(scenarios):
    line, = ax2.plot(sol_time_arrays[:,0], savgol_filter(knee_angles[:, idx],
                                                   window,order,
                                    mode='nearest'), color=my_colors[idx])
    handles.append(line)
    labels.append(labels_sen[idx])
ax2.set_ylabel('Knee flexion(-)', fontsize=16)
ax2.set_xlabel('Time (sec)', fontsize=13)
ax2.grid(True)
...
for idx, fit in enumerate(scenarios):
    line, = ax3.plot(sol_time_arrays[:,0], savgol_filter(ankle_angles[:, idx], window, order,
                                     mode='nearest'), color=my_colors[idx])
    handles.append(line)
    labels.append(labels_sen[idx])
ax3.set_ylabel('Ankle flexion(+)', fontsize=16)
ax3.set_xlabel('Time (sec)', fontsize=13)
ax3.grid(True)
ax3.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax3.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
...
handles = []
labels = []
ax4 = fig_sol.add_subplot(spec1[1, 0])
for idx, fit in enumerate(scenarios):
    line, = ax4.plot(sol_time_arrays[:,0], savgol_filter(hip_adds[:, idx],
                                                   window,order,
                                    mode='nearest'), color=my_colors[idx])
    handles.append(line)
    labels.append(labels_sen[idx])
ax4.set_ylabel('Hip adduction(+)', fontsize=16)
ax4.set_xlabel('Time (sec)', fontsize=13)
ax4.grid(True)
ax4.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax4.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
lg2 = ax4.legend(handles, labels, prop={'weight': 'bold', 'size': 10},
                 loc='upper left', handletextpad=0.4, handlelength=0.5)
for line in lg2.get_lines():
    line.set_linewidth(8)
...
handles = []
labels = []
ax5 = fig_sol.add_subplot(spec1[1, 1])
for idx, fit in enumerate(scenarios):
    line, = ax5.plot(sol_time_arrays[:,0], savgol_filter(hip_rots[:, idx],
                                                   window,order,
                                    mode='nearest'), color=my_colors[idx])
    handles.append(line)
    labels.append(labels_sen[idx])
ax5.set_ylabel('Hip internal rotation(+)', fontsize=16)
ax5.set_xlabel('Time (sec)', fontsize=13)
ax5.grid(True)
ax5.axvspan(time_maxfy, time_maxfy + 0.0001, alpha=a, color=c1, linestyle=mls)
ax5.axvspan(time_igc, time_igc + 0.0001, alpha=a, color=c2, linestyle=mls)
lg2 = ax5.legend(handles, labels, prop={'weight': 'bold', 'size': 10},
                 loc='lower left', handletextpad=0.4, handlelength=0.5)
for line in lg2.get_lines():
    line.set_linewidth(8)
