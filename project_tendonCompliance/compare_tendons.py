...
scenarios = ['Predict_ImplicitTendonComplianceDynamics_PassiveFiberForce', 'RigidTendon_h30']
labels_sen = ['with_TC', 'without_TC']
my_colors = ['royalblue',  'mediumpurple','cadetblue',
             'darkslategrey', 'darkred', 'black']
...
fig1.suptitle('Drop - Landing: Initial Landing Height case study',
...
fig3.suptitle('Drop - Landing: Initial Landing Height case study',
                 fontsize=26, fontweight='bold')
...
fig_sol.suptitle('Drop - Landing: Initial Landing Height case study',
                 fontsize=26, fontweight='bold')
