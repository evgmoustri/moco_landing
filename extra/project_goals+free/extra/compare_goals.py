...
# # Internal rotation  (+)
name = 'goals'
# scenarios = ['trunk_free_ef0.002_jr0.002',
# scenarios = ['trunk_free_ef1_jr0.002', 'trunk_free_ef1_jr1',
#              'trunk_free_ef0.002_jr1', 'trunk_free_ef0.002_jr0.002']
#
# labels_sen = ['trunk_free_ef1_jr0.002', 'trunk_free_ef1_jr1',
#              'trunk_free_ef0.002_jr1', 'trunk_free_ef0.002_jr0.002' ]


scenarios = ['trunk_free_ef1_jr0.002',
             'trunk_free_ef0.002_jr1', "trunk_free_ef0.002_jr10"]

labels_sen = ['trunk_free_ef1_jr0.002',
             'trunk_free_ef0.002_jr1', "trunk_free_ef0.002_jr10" ]


my_colors = [ 'mediumpurple','cadetblue','palevioletred', 'royalblue']
