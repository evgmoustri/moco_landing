...
scenario = "case_Gait2392_track_trunk_rot-10_mtpFree_kostas"
final_time = 0.4
initial_time = 0.05

lumbar_ext_final = 0
lumbar_rot_final = np.deg2rad(-10)
lumbar_ben_final = 0
...
model_file = os.path.abspath(model_path
                             +"/Gait2392\gait2392_only_left_new_spheres_kostas"
                              ".osim")
...
problem.setStateInfoPattern("/jointset/back/lumbar_rotation/value",
                            osim.MocoBounds(lumbar_rot_final-0.01, 0.01),
