...
my_colors = ['red','black', 'gray',
             'purple', 'tan', 'goldenrod','olive',
             'darkseagreen',  'seagreen']

scenarios = ['rot_-20', 'rot_-15', 'rot_-10',
             'rot_-5', 'track', 'rot_5', 'rot_10', 'rot_15',  'rot_20',
             ]
scenarios_2 = ['rot_-20', 'rot_-15', 'rot_-10',
               'rot_-5', 'rot_0', 'rot_5', 'rot_10',
               'rot_15',  'rot_20']
...
ax2.grid(True)
ax2.set_title('GRF (hip rotation)', fontsize=24, fontweight='bold')
...
plt.savefig(results_path + '/GRF_rot.png')
plt.show()
...
ax2.set_xlabel('Time (sec)', fontsize=16)
ax2.grid(True)
ax2.set_title('JRA (hip rotation)', fontsize=24, fontweight='bold')
lg2 = ax2.legend(handles, labels, prop={'weight': 'bold', 'size': 10},
                 loc='upper left', handletextpad=0.4, handlelength=0.5)
for line in lg2.get_lines():
    line.set_linewidth(8)
...
plt.savefig(results_path + '/JRA_rot.png')
plt.show()
print('ok')
