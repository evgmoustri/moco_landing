...
at_dict = {
    # Rotation
    1: {'scenario': 'rot_-30', 'hip_rot_final': -30, 'hip_abd_final': 0,
        'pelvis_ty_final': 0.85},
    2: {'scenario': 'rot_-25', 'hip_rot_final': -25, 'hip_abd_final': 0,
        'pelvis_ty_final': 0.85},
    3: {'scenario': 'rot_-20', 'hip_rot_final': -20, 'hip_abd_final': 0,
        'pelvis_ty_final': 0.85},
    4: {'scenario': 'rot_-15', 'hip_rot_final': -15, 'hip_abd_final': 0,
        'pelvis_ty_final': 0.85},
    5: {'scenario': 'rot_-10', 'hip_rot_final': -10, 'hip_abd_final': 0,
        'pelvis_ty_final': 0.85},
    6: {'scenario': 'rot_-5', 'hip_rot_final': -5, 'hip_abd_final': 0,
        'pelvis_ty_final': 0.85},
    7: {'scenario': 'rot_5', 'hip_rot_final': 5, 'hip_abd_final': 0,
        'pelvis_ty_final': 0.85},
    8: {'scenario': 'rot_10', 'hip_rot_final': 10, 'hip_abd_final': 0,
        'pelvis_ty_final': 0.85},
    9: {'scenario': 'rot_15', 'hip_rot_final': 15, 'hip_abd_final': 0,
        'pelvis_ty_final': 0.85},
    10: {'scenario': 'rot_20', 'hip_rot_final': 20, 'hip_abd_final': 0,
         'pelvis_ty_final': 0.85},
    11: {'scenario': 'rot_25', 'hip_rot_final': 25, 'hip_abd_final': 0,
         'pelvis_ty_final': 0.85},
    12: {'scenario': 'rot_30', 'hip_rot_final': 30, 'hip_abd_final': 0,
         'pelvis_ty_final': 0.85},
    # Abduction
    13: {'scenario': 'abd_-10', 'hip_rot_final': 0, 'hip_abd_final': -10,
         'pelvis_ty_final': 0.84},
    14: {'scenario': 'abd_-8', 'hip_rot_final': 0, 'hip_abd_final': -8,
         'pelvis_ty_final': 0.84},
    15: {'scenario': 'abd_-6', 'hip_rot_final': 0, 'hip_abd_final': -6,
         'pelvis_ty_final': 0.855},
    16: {'scenario': 'abd_-4', 'hip_rot_final': 0, 'hip_abd_final': -4,
         'pelvis_ty_final': 0.85},
    17: {'scenario': 'abd_-2', 'hip_rot_final': 0, 'hip_abd_final': -2,
         'pelvis_ty_final': 0.85},
    18: {'scenario': 'abd_2', 'hip_rot_final': 0, 'hip_abd_final': 2,
         'pelvis_ty_final': 0.85},
    19: {'scenario': 'abd_4', 'hip_rot_final': 0, 'hip_abd_final': 4,
         'pelvis_ty_final': 0.85},
    20: {'scenario': 'abd_6', 'hip_rot_final': 0, 'hip_abd_final': 6,
         'pelvis_ty_final': 0.855},
    21: {'scenario': 'abd_8', 'hip_rot_final': 0, 'hip_abd_final': 8,
         'pelvis_ty_final': 0.84},
    22: {'scenario': 'abd_10', 'hip_rot_final': 0, 'hip_abd_final': 10,
         'pelvis_ty_final': 0.84}
}
...
for i in range(len(at_dict)):
    ...
    hip_rot_final = np.deg2rad(at_dict[i+1]['hip_rot_final'])
    hip_abd_final = np.deg2rad(at_dict[i+1]['hip_abd_final'])
    pelvis_ty_final = at_dict[i+1]['pelvis_ty_final']


    results_path = os.path.abspath(project_path + "/Results/Hip/" +
                                   scenario)
    ...
    problem.setStateInfo("/jointset/ground_pelvis/pelvis_ty/value",
            ...
            1.25), osim.MocoFinalBounds(0.75, pelvis_ty_final))
    ...
    # -----------------------------------------------------------
    if hip_rot_final >= 0:
        problem.setStateInfoPattern("/jointset/hip_l/hip_rotation_l/value",
                                osim.MocoBounds(-0.01, hip_rot_final + 0.01),
                                osim.MocoInitialBounds(hip_rot_final - 0.01,
                                                       hip_rot_final + 0.01))
    # flexion
    else:
        problem.setStateInfoPattern("/jointset/hip_l/hip_rotation_l/value",
                                    osim.MocoBounds(hip_rot_final - 0.1, 0.01),
                                    osim.MocoInitialBounds(hip_rot_final - 0.01,
                                                           hip_rot_final + 0.01))
    if hip_abd_final >= 0:
        problem.setStateInfoPattern("/jointset/hip_l/hip_adduction_l/value",
                                osim.MocoBounds(-0.01, hip_abd_final + 0.01),
                                osim.MocoInitialBounds(hip_abd_final - 0.01,
                                                       hip_abd_final + 0.01))
    else:
        problem.setStateInfoPattern("/jointset/hip_l/hip_adduction_l/value",
                                    osim.MocoBounds(hip_abd_final - 0.1, 0.01),
                                    osim.MocoInitialBounds(hip_abd_final - 0.01,
                                                           hip_abd_final + 0.01))
    ...
    # Right Leg
    # -----------------------------------------------------------
    problem.setStateInfoPattern("/jointset/hip_r/hip_adduction_r/value",
                                osim.MocoBounds(-0.01, 0.01),
                                osim.MocoInitialBounds(0))
    problem.setStateInfoPattern("/jointset/hip_r/hip_rotation_r/value",
                                osim.MocoBounds(-0.01, 0.01),
                                osim.MocoInitialBounds(0))
    # -----------------------------------------------------------
    # Both Legs
