...
from utils import fix_controls, read_GRF_JR_file, index_containing_substring,\
    estimate_cop, readExternalLoadsFile, plot_muscle_forces_Mokhtazadeh, plot_muscle_forces_Sritharan, \
    fix_sto_2392
...
lumbar_ext_final = np.deg2rad(-40)
lumbar_rot_final = 0
lumbar_ben_final = 0
...
hip_rot_final = np.deg2rad(0)
hip_abd_final = np.deg2rad(-8)
