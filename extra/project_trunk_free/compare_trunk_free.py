...
results_path = os.path.abspath(project_path +
                               "/Results/Compare//predict_trunk_free_ef_0.01")
if not os.path.isdir(results_path):
    os.makedirs(results_path)
results_path_trunk = os.path.abspath(project_path +
                                     "/Results/predict_trunk_free_ef_0.01")

# Internal
name = 'predict_trunk_free'

scenarios = ['trunk_all_restr', 'trunk_ext_free',
             'trunk_ben_free', 'trunk_rot_free',
             'trunk_all_free']

labels_sen = ['trunk_all_restr', 'trunk_ext_free',
             'trunk_ben_free', 'trunk_rot_free',
             'trunk_all_free']
...
fig1.suptitle('   Weight of Moco Control Goal', fontsize=26, \
                                                           fontweight='bold')
...
spec1 = gridspec.GridSpec(ncols=ncol, nrows=nr, figure=fig1)
fig1.suptitle('Weight of Moco Control Goal', fontsize=26, fontweight='bold')
ax1 = fig1.add_subplot(spec1[0, 0])
for idx, fit in enumerate(scenarios):
...
fig3.suptitle('      Weight of Moco Control Goal', fontsize=26,
                   fontweight='bold')
...
fig_sol.suptitle('Weight of Moco Control Goal',
