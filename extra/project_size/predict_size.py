...
# at_dict = {
#     1: {'scenario': 'FemaleSmall', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
#         'lumbar_ben_final': 0, 'height': 1.19, 'model': 'FemaleSmall.osim',
#         'ty_final': 0.75},
#     2: {'scenario': 'FemaleMedium', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
#         'lumbar_ben_final': 0, 'height': 1.24, 'model': 'FemaleMedium.osim',
#         'ty_final': 0.79},
#     3: {'scenario': 'FemaleLarge', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
#         'lumbar_ben_final': 0, 'height': 1.28, 'model': 'FemaleLarge.osim',
#         'ty_final': 0.83},
#     4: {'scenario': 'MaleSmall', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
#         'lumbar_ben_final': 0, 'height': 1.26, 'model': 'MaleSmall.osim',
#         'ty_final': 0.81},
#     5: {'scenario': 'MaleMedium', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
#         'lumbar_ben_final': 0, 'height': 1.31, 'model': 'MaleMedium.osim',
#         'ty_final': 0.85},
#     6: {'scenario': 'MaleLarge', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
#         'lumbar_ben_final': 0, 'height': 1.3, 'model': 'MaleLarge.osim',
#         'ty_final': 0.85}
# }
...
for i in range(len(at_dict)):
    ...
    results_path = os.path.abspath(project_path +
                                   "/Results/predict_size_effort0.001/" +
                                   scenario)
    ...
    problem.setStateInfo("/jointset/ground_pelvis/pelvis_ty/value",
                         ...
                         osim.MocoFinalBounds(0.5, ty_final))
    ...
    solver.setGuessFile(project_path +
                        "/Results/predict_size_effort0.001/FemaleMedium/"
                        "/solution.sto")
