...
results_path_trunk = os.path.abspath(project_path +
                                     "/Results/")
if not os.path.isdir(results_path_trunk):
    os.makedirs(results_path_trunk)
scenarios = ['case_Gait2354_track', 'case_Gait2392_track',
             ]

# 'case_Gait2392_inverese'case_Gait2392_inverese
...
my_colors = ['royalblue', 'palevioletred','darkslategrey']
...
ax2.grid(True)
ax2.set_title('Groun Reaction Forces and Moments', fontsize=24,
              fontweight='bold')
...
my_colors = ['royalblue',  'mediumpurple','cadetblue','palevioletred',
             'darkslategrey', 'darkred', 'indianred', 'salmon', 'pink',
             'goldenrod','hotpink']
...
#               # 'qh_ratio': str(max_qh_ratio),
#               # 'gta_ratio': str(max_gta_ratio),
#               }
#     # d = [d, dict_i]
#     with open(results_path + '/output.csv',
#               'a') as f:
