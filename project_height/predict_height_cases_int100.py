...
at_dict = {
    ...
    2: {'scenario': 'h20', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
        'lumbar_ben_final': 0, 'height': 1.15},
    3: {'scenario': 'h15', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
        'lumbar_ben_final': 0, 'height': 1.1},
    4: {'scenario': 'h30', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
        'lumbar_ben_final': 0, 'height': 1.25},
    5: {'scenario': 'h35', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
        'lumbar_ben_final': 0, 'height': 1.3},
    6: {'scenario': 'h40', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
        'lumbar_ben_final': 0, 'height': 1.35},
    7: {'scenario': 'h45', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
        'lumbar_ben_final': 0, 'height': 1.40},
    8: {'scenario': 'h50', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
        'lumbar_ben_final': 0, 'height': 1.45},
    9: {'scenario': 'h55', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
        'lumbar_ben_final': 0, 'height': 1.50},
    10: {'scenario': 'h60', 'lumbar_ext_final': 0, 'lumbar_rot_final': 0,
        'lumbar_ben_final': 0, 'height': 1.55}
}
...
for i in range(len(at_dict)):
    ...
    results_path = os.path.abspath(project_path +
                                   "/Results/predict_height_effort0.001_3/" +
                                   scenario)
