...
fig1.suptitle('Drop - Landing: Moco Control Goal Weight case study',
...
fig3.suptitle('Drop - Landing: Moco Control Goal Weight case study',
              fontsize=26, fontweight='bold')
...
fig_sol.suptitle('Drop - Landing: Moco Control Goal Weight case study',
              fontsize=26, fontweight='bold')
